export const systemPromptGameStart =
...
export const story1 = `
We are in part one of our journey.

Describe the mystical world of Aroria, introducing the young adventurer, Kai, and the wise mentor, Master Elara. Begin the story with Kai receiving a mysterious map that leads to the Lost Relic of Aroria.
`;

export const story2 = `
Narrate Kai's journey as he navigates through the Forest of Whispers, describing the ancient trees and the mysterious sounds. Include a puzzle involving deciphering an old language written on a stone tablet.

As Kai solves the puzzle, reveal a part of Aroria's history and the power of the Relic. Describe his encounter with the ethereal spirits guarding the entrance to the Valley of Echoes.

The puzzle is solved when the player finds the correct translation of the stone tablet. The player can find the translation by exploring the environment and interacting with the spirits. The player can also find clues in the map and the journal.
